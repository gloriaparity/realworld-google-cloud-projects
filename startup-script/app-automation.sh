...
sudo wget https://github.com/gloriaparity/realworld-google-cloud-projects/edit/main/database-config/wp-config.php -P /etc/apache2/sites-enabled/
...
sudo wget https://github.com/gloriaparity/realworld-google-cloud-projects/edit/main/database-config/wp-config.php -P /var/www/wordpress/
